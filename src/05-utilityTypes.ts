...
console.log(updateFriend(friends[0], {phone: "08712345", dob: new Date("1999-10-22")}));
...
type ColleagueFriend = Pick<Friend, "name" | "age"> & {contact: Pick<Colleague["contact"], "email" | "extension">;};

function intersection(friends: Friend[], colleagues: Colleague[]): ColleagueFriend[] {
